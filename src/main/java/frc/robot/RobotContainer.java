...
public class RobotContainer {
  ...
  private void configureButtonBindings() {
    ...
    .whenPressed(new ShooterShootBalls(shooterSub, 120000))
    .whenPressed(new ConstantFeedWhenShooterReady(verticalConveyerSub, 120000)) //.whenPressed(new FeedWhenShooterReady(verticalConveyerSub))
